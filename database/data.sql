...
values
    (
        'We have a team of hotel accommodation consultants with wide-ranging expertise in identifying and handling the most suitable accommodation options for any conference. No matter the size, our accommodation management team has the knowledge about available venues and the skills needed to book and manage accommodation for conferences with up to twenty-five thousand delegates.We have a team of hotel accommodation consultants with wide-ranging expertise in identifying and handling the most suitable accommodation options for any conference. No matter the size, our accommodation management team has the knowledge about available venues and the skills needed to book and manage accommodation for conferences with up to twenty-five thousand delegates.',
        'The success of an event depends on much more than what happens at the venue.Event organisers are also expected to provide a full range of services,and accommodation is a vital element. expected to provide a full range of services,and accommodation is a vital element.',
...
insert into
    tbl_hairtransplant (learnmore, explanation)
values
    (
